	...
	function serialize_return() {
		...
		// returned value(s)
			...
			$this->debug('serializing return value');
       			if($this->wsdl){
		                /****Patch by Tim Williams - opParams needs a default value****/
                                $opParams=array();
		                	...
		                	if (! $list2[$ii]['loaded']) {
								...
								if ($url != '') {
									...
									if (!isset($urlparts['host'])) {
                                                                                /***tmw bugfix for importing local files***/
                                                                                if (!isset($wsdlparts['scheme']) || strlen($wsdlparts['scheme'])==0)
                                                                                        $wsdlparts['scheme']='file';
                                                                                /***end of bug fix***/
