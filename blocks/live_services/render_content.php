...
*******************************************************************************/
    ...
    $content_html .= "<div class='live_services_wrapper_div'>";
    ...
    if( !empty( $CFG->block_live_services_showIdentity ) )
    {
        $content_html .= $identity->Render( $courseId, $this->version );
    }
    ...
    if( $identity->IsSignedIn() )
    {
        ...
        // alerts
        if( class_exists( 'AlertsService' ) && !empty( $CFG->block_live_services_showAlerts ) )
        {
            $alertsServiceObject = new AlertsService();
            $content_html .= $alertsServiceObject->Render( $courseId, $identity->IsTeacher($courseId) );
        }
    }
