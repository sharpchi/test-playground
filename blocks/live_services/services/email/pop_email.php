...
*******************************************************************************/
    ...
    $changeKey = @$_GET['ct'];
    $action = @$_GET['action'];
    if($courseid!==null && (int)$courseid > 1)
    {
        $showFiles = true;
    }
    else
    ...
    if(isset($itemId) && isset($changeKey) && isset($action))
    {
            ...
            <table id="emailOptionsTable" class="bodyMainTable" style="width:624px">
                <tr>
                    ...
                    <div id="autoCompletePanel" style="z-index:1">
                        <input id="to" type="text" style="width:550px;" tabindex="1" title="" value="<?php echo(isset($invitee)? $invitee:'');?>" />
