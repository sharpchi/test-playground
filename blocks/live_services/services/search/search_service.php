    ...
    function Render()
    {
        ...
        <div class='live_service_div' id="searchServiceContainer">
            <form name='searchForm' action='' onsubmit='return false;'>
                ...
                <table width='100%'><tr><td><div style="line-height:28px">
                <input type='text' size='15' style='width: 95%;' name='searchFor'
                        onkeypress='return textboxKeyPress( event )'; /></td><td width='1%'><img id='searchBingImage'
                        ...
                        style='vertical-align: text-bottom; cursor:pointer;' /></div></td></tr></table>
            </form>
        </div>
SEARCH_SERVICE;
