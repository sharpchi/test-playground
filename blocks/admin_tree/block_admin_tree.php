...
class block_admin_tree extends block_base {  // parent class block_base in  admin_tree/moodleblock.class.php
    ...
    function build_tree (&$content) {
		...
		if (is_a($content, 'admin_settingpage')) {   // see if $content is an object of class admin_settingpage
